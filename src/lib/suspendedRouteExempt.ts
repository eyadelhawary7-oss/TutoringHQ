 ...
 * `/reactivate` (standalone pay page), `/billing` (the customer invoices / pay
 * page, where a locked customer pays the outstanding invoice to unlock), and the
 ...
 * `/billing-archive`, or `/suspended-archive`.
 *
