...
export const WA_TEMPLATE_PREVIEW_SAMPLES: Record<string, string> = {
  ...
  groups_url: 'https://tutoringhq.app/ar/groups',
  settings_url: 'https://tutoringhq.app/ar/settings',
  scan_url: 'https://tutoringhq.app/ar/scan',
  invite_url: 'https://tutoringhq.app/ar/accept-invite?token=demo',
  role_label: 'مساعد',
  ...
  payment_link: 'https://tutoringhq.app/ar/settings/billing',
  login_link: 'https://tutoringhq.app/ar/login',
  session_fee: '150 ج.م',
