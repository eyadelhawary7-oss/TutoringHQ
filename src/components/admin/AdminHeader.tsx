...
export function AdminHeader() {
  ...
  return (
    <>
      <header className="hidden lg:flex fixed top-0 start-0 end-0 h-14 z-30 items-center justify-between px-4 md:px-6 border-b border-[var(--color-border-subtle)] bg-[var(--color-surface-1)]">
        <span
          className="text-lg"
