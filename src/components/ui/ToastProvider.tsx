  ...
  return (
    <>
      ...
      <div
        ...
        className="pointer-events-none fixed bottom-4 left-1/2 z-[9999] flex w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 flex-col gap-2 sm:bottom-auto sm:left-auto sm:right-4 sm:top-4 sm:w-auto sm:translate-x-0"
      >
        {toasts.map((x) => (
