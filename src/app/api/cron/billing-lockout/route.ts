/**
 * Single-day billing lockout tick (Job 3, Part 2). Runs hourly as a Vercel cron
 * (UTC), but every decision is Cairo-wall-clock driven and DST-safe: the pure
 * scheduler fires the invoice+nudge at 00:00 Cairo, same-day card retries at the
