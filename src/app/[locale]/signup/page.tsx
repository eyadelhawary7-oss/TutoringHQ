...
const TOP_CENTERS_WHATSAPP = 'https://wa.me/201001963432?text=مرحباً، أنا مهتم بباقة كبار السناتر';
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <a
                    ...
                    className="flex items-start gap-3 p-4 border-2 border-amber-400 dark:border-amber-500 rounded-lg bg-amber-50/50 dark:bg-amber-900/20 hover:bg-amber-100/50 dark:hover:bg-amber-900/30 transition-colors block"
                  >
                    <span className="mt-1 flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-amber-100 dark:bg-amber-900/50">
                    ...
                    <div className="flex-1">
                      <span className="block text-gray-900 dark:text-white font-medium">
                        {t('topCenters')} — {t('contactSales')}
                      </span>
                      <span className="block text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                        {t('topCentersDesc')} — {t('customPricing')}
                      </span>
                    </div>
