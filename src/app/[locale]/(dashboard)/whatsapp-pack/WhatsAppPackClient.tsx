      ...
      <div className="min-h-screen w-full bg-[var(--color-surface-0)] px-4 py-6 pb-24 md:pb-8 max-w-5xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="flex justify-end" dir="ltr">
            <div className="max-w-[min(100%,20rem)] rounded-2xl rounded-se-sm border border-[var(--color-border-subtle)] bg-[var(--color-surface-2)] px-3 py-2.5 text-sm text-[var(--color-text-primary)] shadow-sm">
              {blastType === 'ops'
