      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl w-full text-center space-y-8">
          ...
          <div className="pt-6 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center px-6 py-3 text-lg font-medium text-indigo-600 dark:text-indigo-400 bg-white dark:bg-gray-800 border-2 border-indigo-600 dark:border-indigo-500 rounded-full hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors"
            >
              {t('signupButton')}
            </Link>
          </div>
