  ...
  return (
    ...
    >
      ...
      >
        ...
        {showTrialTerms && (
          <div className="mb-4 rounded-lg border border-teal-800 bg-teal-900/20 p-4">
            <div className="mb-2 flex items-center gap-2">
              <Sparkles size={16} className="text-teal-400" aria-hidden />
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-0)] px-3 py-2 text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
          />
        </div>
        <div className="mb-4">
          <label className="mb-1 block text-sm font-medium text-[var(--color-text-primary)]">
