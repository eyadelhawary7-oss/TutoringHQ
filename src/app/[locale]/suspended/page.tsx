    ...
    >
      ...
      <div className="chq-spring-in w-full max-w-md space-y-6 text-center">
        ...
        <div className="flex flex-col gap-3">
          <Link
            href={isPaymentOverdue ? '/pay' : '/reactivate'}
            className="rounded-xl bg-amber-500 px-6 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-amber-600 btn-press chq-focus"
          >
            {t('payNow')}
          </Link>
          {waHref ? (
