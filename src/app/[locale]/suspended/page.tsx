      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-red-100 dark:from-gray-900 dark:via-red-950 dark:to-gray-900">
        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-4">
          <div className="max-w-md w-full text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">{t('overdue', { defaultValue: 'Account Suspended' })}</h1>
            <p className="text-gray-600 dark:text-gray-400 mb-6">{t('overdueMessage', { defaultValue: 'تم إيقاف حسابك بسبب تأخر السداد. للتجديد تواصل معنا' })}</p>
            ...
            <button onClick={handleLogout} className="mt-6 text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-400">{t('logout')}</button>
          </div>
        </div>
      </div>
    );
