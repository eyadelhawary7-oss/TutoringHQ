...
- **Reconfirmed 4 Aug 2026** (build pass, PR #339). `select count(*) from group_join_links` → **0**, live, unchanged. Still zero readers in `src/`. The link card was left on the full UUID; nothing in this pass's §03 work depends on the short form.
