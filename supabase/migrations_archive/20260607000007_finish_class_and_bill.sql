-- finish_class_and_bill (canonical). This file is OVERWRITTEN during repo sync so a
-- replay reproduces the final definition, not the stale e8774fc body.
-- Captured verbatim from live prod via pg_get_functiondef.
