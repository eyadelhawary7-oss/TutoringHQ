-- apply_student_credits: net active credits against oldest pending lesson bills.
-- Whole-credit application (Model X): a credit applies only if it fits within remaining outstanding.
